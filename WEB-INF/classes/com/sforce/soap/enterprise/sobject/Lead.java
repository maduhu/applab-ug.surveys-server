...
public class Lead  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.util.Date donation_Close_Date__c;
    ...
    public Lead(
           ...
           java.util.Date donation_Close_Date__c,
        ...
        this.donation_Close_Date__c = donation_Close_Date__c;
        this.email = email;
    ...
    /**
     * Gets the donation_Amount__c value for this Lead.
     * 
    ...
    /**
     * Sets the donation_Amount__c value for this Lead.
     * 
    ...
    /**
     * Gets the donation_Close_Date__c value for this Lead.
     * 
     * @return donation_Close_Date__c
     */
    public java.util.Date getDonation_Close_Date__c() {
        return donation_Close_Date__c;
    }


    /**
     * Sets the donation_Close_Date__c value for this Lead.
     * 
     * @param donation_Close_Date__c
     */
    public void setDonation_Close_Date__c(java.util.Date donation_Close_Date__c) {
        this.donation_Close_Date__c = donation_Close_Date__c;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.donation_Close_Date__c==null && other.getDonation_Close_Date__c()==null) || 
             (this.donation_Close_Date__c!=null &&
              this.donation_Close_Date__c.equals(other.getDonation_Close_Date__c()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDonation_Close_Date__c() != null) {
            _hashCode += getDonation_Close_Date__c().hashCode();
        }
        if (getEmail() != null) {
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("donation_Close_Date__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Donation_Close_Date__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
