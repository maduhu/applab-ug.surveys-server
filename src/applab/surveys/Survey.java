...
public class Survey {
	 ...
	 * 
	 * @param basic
	 *            - if true only load the basic details. Doesn't join to the
	 *            answers table.
	 */
	...
	/**
	 * Compares the BackEndSurvey to the Salesforce survey. For the changes to
	 * be considered acceptable the question orders must still match. The
	 * question types must match.
	 * 
	 * The question text can change and we can add extra selects to a multiple
	 * select. This does mean that a user could sabotage a survey if they wanted
	 * to but there is little we can realistically do about that.
	 * 
