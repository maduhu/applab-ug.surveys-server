...
public class Survey {
    ...
    public HashMap<Integer, Submission> getSubmissions(SubmissionStatus submissionFilter, java.sql.Date startDate, java.sql.Date endDate,
                                                       boolean basic, boolean showDraft)
            throws ClassNotFoundException, SQLException, ParseException, SAXException, IOException, ParserConfigurationException {
     ...
     */
    public void loadSubmissions(SubmissionStatus submissionStatus, java.sql.Date startDate, java.sql.Date endDate, boolean basic,
            ...
            for (String questionName : this.backendSurveyXml.getQuestionOrder()) {
                ...
                for (int i = 1; i <= question.getTotalInstances(); i++) {
                    ...
                    if ("Select".equals(question.getType().toString())) {
                        ...
                        if (answer == null || answer.getFriendlyAnswerText(true, this) == null
    ...
    public boolean loadSurvey(String salesforceId, boolean getFromSalesforce)
            throws SQLException, ClassNotFoundException, ServiceException, InvalidIdFault, UnexpectedErrorFault, LoginFault,
            RemoteException {
        ...
        if (getFromSalesforce) {
            ...
            if (query.getSize() > 1) {
                ...
                // Survey doesn't exist. Should not really happen as to get to this code the survey needs to be in
                // salesforce already
                return false;
            }
    ...
    HashMap<Integer, Submission> loadSubmissions(SubmissionStatus statusFilter, java.sql.Date startDate, java.sql.Date endDate,
                                                 boolean basic, boolean showDraft)
            throws ClassNotFoundException, SQLException, ParseException, SAXException, IOException, ParserConfigurationException {
        ...
        while (resultSet.next()) {
            ...
            if (!order.contains(currentSubmissionId)) {
                ...
                if (submissionStatus == null) {
                    submissionStatus = SubmissionStatus.parseDisplayName(resultSet.getString("status") == null ? "Not Reviewed" : resultSet
                            .getString("status"));
                }
